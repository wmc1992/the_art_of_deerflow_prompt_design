...
>
> 约束型：你**不得**做 X。
> 后果型：如果你做了 X，Y 将会发生（而 Y 对你/用户有害）。
...
>
> 可用技能：
> - **code**（/code）：用任何编程语言编写、审查、调试代码。[……]
> - **deep-research**（/deep-research）：进行全面的多步骤深度研究。[……]
...
> **中文附注**：
>
> workContext（工作背景）：2–3 句
> personalContext（个人背景）：1–2 句
> topOfMind（近期关注）：3–5 句，详细段落
> recentMonths（近几个月）：4–6 句或 1–2 段
